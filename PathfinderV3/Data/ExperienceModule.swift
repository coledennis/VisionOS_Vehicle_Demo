...
//             HotSpotData(placement: 5, title: "Operator-Centric Design", description: "Prioritize operator well-being with the Volvo L220H Loader's thoughtfully designed cabin, offering unmatched comfort and control. Ergonomically positioned controls, spacious interior, and excellent visibility ensure operators remain focused and comfortable during long hours of operation.")
        ...
        case .precheck:
            [
                HotSpotData(placement: 1, title: "Engine Off", description: "Before starting any checks, make sure to verify that the engine is completely deactivated to ensure safety and prevent any accidental startup.", coordinate: .top),
                HotSpotData(placement: 2, title: "Check Teeth", description: "Perform a thorough examination of the teeth to ensure they are in proper working order, without any signs of damage or malfunction, as they are crucial for efficient operation.", imageName: "Pre-Check 2", coordinate: .teeth),
                HotSpotData(placement: 3, title: "Inspect Hose Linkage", description: "Take time to inspect the hoses at the linkage points carefully. Look for any signs of leaks or damage, as these could lead to operational issues or fluid loss.", imageName: "Pre-Check 3", coordinate: .back),
